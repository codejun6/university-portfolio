================================================================================
    MFC 라이브러리 : PhotoGalmuri 프로젝트 개요
================================================================================

응용 프로그램 마법사에서 이 PhotoGalmuri 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 PhotoGalmuri 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.

PhotoGalmuri.vcxproj
...
PhotoGalmuri.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CPhotoGalmuriApp 응용 프로그램
    클래스를 선언합니다.

PhotoGalmuri.cpp
    응용 프로그램 클래스 CPhotoGalmuriApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\PhotoGalmuri.ico
    응용 프로그램의 아이콘으로 사용되는 아이콘 파일입니다. 이 아이콘은
    주 리소스 파일인 PhotoGalmuri.rc에 의해 포함됩니다.

res\PhotoGalmuri.rc2
...
GALGalmuriDoc.h, GALGalmuriDoc.cpp - 문서
    이 파일에는 CGALGalmuriDoc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CGALGalmuriDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

GALGalmuriView.h, GALGalmuriView.cpp - 문서 뷰
    이 파일에는 CGALGalmuriView 클래스가 들어 있습니다.
    CGALGalmuriView 개체는 CGALGalmuriDoc 개체를 보는 데 사용됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 PhotoGalmuri.pch와
